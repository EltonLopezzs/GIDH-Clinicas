    ...
    def editar_anamnese(paciente_doc_id, anamnese_doc_id):
        ...
        try:
            ...
            if anamnese_doc.exists:
                ...
                return render_template('anamnese_form.html', anamnese=anamnese_doc.to_dict(), paciente_id=paciente_doc_id, paciente_nome=paciente_nome, action_url=url_for('editar_anamnese', paciente_doc_id=paciente_doc_id, anamnese_doc_id=anamnese_doc_id), page_title=f"Editar Anamnese para {paciente_nome}")
            else:
