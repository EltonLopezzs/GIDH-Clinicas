        ...
        for p_doc in profissionais_docs_stream:
            ...
            for horario_doc in horarios_docs_para_profissional_stream:
                ...
                if horario:
                    ...
                    horario['profissional_nome'] = professional_nome_atual
...
@schedules_bp.route('/horarios/novo', methods=['GET', 'POST'])
@login_required
@admin_required
def adicionar_horario():
    ...
    if request.method == 'POST':
        try:
            ...
            if not profissional_id_selecionado:
                ...
                return redirect(url_for('schedules_bp.listar_horarios'))
        except ValueError:
    ...
    return render_template('horario_form.html',   
                            ...
                            horario=None,   
                            action_url=url_for('schedules_bp.adicionar_horario'),
                            page_title='Adicionar Novo Horário',
                            current_year=datetime.datetime.now(SAO_PAULO_TZ).year)


@schedules_bp.route('/profissionais/<string:profissional_doc_id>/horarios/editar/<string:horario_doc_id>', methods=['GET', 'POST'])
@login_required
        ...
        try:
            ...
            if hora_inicio >= hora_fim:
                ...
                if intervalo_minutos is not None:
                    ...
                    horario_data_update['intervalo_minutos'] = db.DELETE_FIELD
    ...
    try:
        ...
        if horario_doc_snapshot.exists:
            ...
            if horario_data_db:
                ...
                horario_data_db['profissional_id_fk'] = professional_doc_id
                ...
                if professional_pai_doc.exists:
                    profissional_pai_data = professional_pai_doc.to_dict()
                    if professional_pai_data:
                        horario_data_db['profissional_nome_atual'] = professional_pai_data.get('nome', professional_doc_id)
                
                return render_template('horario_form.html',   
                                       profissionais=profissionais_ativos_lista,
                                       dias_semana=dias_semana_map,   
                                       horario=horario_data_db,   
                                       action_url=url_for('schedules_bp.editar_horario', profissional_doc_id=profissional_doc_id, horario_doc_id=horario_doc_id),
...
@schedules_bp.route('/profissionais/<string:profissional_doc_id>/horarios/excluir/<string:horario_doc_id>', methods=['POST'])
@login_required
@admin_required
...
@schedules_bp.route('/profissionais/<string:profissional_doc_id>/horarios/ativar_desativar/<string:horario_doc_id>', methods=['POST'])
@login_required
@admin_required
    ...
    try:
        ...
        if horario_doc.exists:
            ...
            if data:
                ...
                horario_ref.update({'ativo': new_status, 'atualizado_em': db.SERVER_TIMESTAMP})
